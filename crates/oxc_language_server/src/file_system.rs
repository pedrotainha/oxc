...
impl ResolvedPath {
    ...
    fn canonical(path: PathBuf) -> Self {
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            #[expect(clippy::disallowed_methods)] // TODO: prefers cow_replace, this is live code
...
mod tests {
    ...
    #[test]
    #[expect(clippy::disallowed_methods)] // prefers cow_replace, only tests
    fn test_uri_to_resolved_path_file() {
        ...
        assert_eq!(
            ...
            path_to_lossy_string(&file).replace("test.txt", "Test.txt")
        );
    }
